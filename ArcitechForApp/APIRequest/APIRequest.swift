...
//           let checkInterNet = Connectivity.isConnectedToInternet()
//           if checkInterNet == true {
//               Alamofire.request(url!, method: .post, parameters: (params), headers: nil).responseJSON { (responsed) in
//                   switch responsed.result { //DataResponse<Any>
//
//                   case .success(_):
//
...
//                           do {
//
//                               if let json = try JSONSerialization.jsonObject(with: responsed.data!, options: []) as? [String: Any] {
//                                   // try to read out a string array
//                                   print("Data = \(json)")
//                                   let value:Int = json["error"] as! Int
//                                   if  value != 0 {
...
//                           }
//                           catch {
//                               failureBlock("Invalied arguments" as AnyObject)
//                           }
//                       }
//                       else
//                       {
